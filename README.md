# utl-altair-slc-using-unit-square-calculate-pKa-maximum-slope-from-titration-curve-for-diprotic-acid
Altair slc using a unit square to calculate pKa maximum slope from titration curve for diprotic acid
    %let pgm=utl-altair-slc-using-unit-square-mapping-calculate-max-pKa-slope-of-titration-curve-for-diprotic-acid;

    %stop_submission;

    Altair slc using unit square mapping calculate max pKa slope of the titration curve for diprotic acid
